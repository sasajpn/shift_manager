json.array! @shift_submissions do |shift_submission|
  ...
  json.title "#{shift_submission.start_time}~#{shift_submission.end_time}　#{shift_submission.member.name}"
...
json.array! @shift_adjustments do |shift_adjustment|
  ...
  json.title "#{shift_adjustment.start_time}~#{shift_adjustment.end_time} #{shift_adjustment.member.name}"
...
json.array! @shift_registrations do |shift_registration|
  ...
  json.title "#{shift_registration.start_time}~#{shift_registration.end_time} #{shift_registration.member.name}"
