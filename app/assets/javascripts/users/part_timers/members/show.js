...
$(function() {
  var member_id = document.getElementById('part_timers_shift_calendar').dataset.member_id

  $('#part_timers_shift_calendar').fullCalendar({
    header: {
      center: '',
    ...
    select: function(start, end, jsEvent, view) {
      $('#part_timers_shift_calendar').fullCalendar('changeView', 'listDay', start);
    },
